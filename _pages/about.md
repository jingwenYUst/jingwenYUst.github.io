...
Exploiting Intrinsic Separability, is accepted to ECCV 2026. Congrats to Dr. Zhonghang LIU. Check out the <a href="https://zhliu-uod.github.io/VUOD/"> Project Page </a> for more details.</li>
    <li><Strong>April/2026</strong>: 🎉🎉🎉 ROVER is accepted to IEEE Trans. on Automation Science and Engineering, T-ASE. Check out the <a href="https://arxiv.org/pdf/2508.13488"> Paper </a> for more details.</li>
    <li><Strong>April/2026</strong>: 🎉 Start developing a ArXiv daily paper reader, please check out the <em>Daily Paper Reader</em> page on the home page.</li>
    ...
    <table style="width:100%;border:0px;border-spacing:0px;border-collapse:separate;margin-right:auto;margin-left:auto;">
      <tr onmouseout="nightsight_stop()" onmouseover="nightsight_start()">
        ...
        <td style="padding:20px;width:75%;vertical-align:middle;border-left-style:none;border-bottom-style:none;border-top-style:none;border-right-style:none">
          ...
          <a href="https://www.youtube.com/watch?v=LLZT9cEa6K0&feature=youtu.be"><img alt="Youtube" src="https://img.shields.io/badge/Video-Youtube-red"/></a>
        </td>
      </tr>
    </table>
